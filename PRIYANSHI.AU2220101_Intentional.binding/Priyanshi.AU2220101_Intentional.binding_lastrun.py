...
expName = 'Priyanshi.AU2220101_Intentional.binding'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\Documents\\PRIYANSHI.AU2220101_Intentional.binding\\Priyanshi.AU2220101_Intentional.binding_lastrun.py',
